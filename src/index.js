            ...
            <table class="cases-table events-table">
              <thead>
                <tr>
                  ...
                  <th style="min-width: 130px;">Event Type</th>
                  <th style="min-width: 160px;">Event Name</th>
                  <th style="min-width: 200px;">Event Data</th>
...
.pagination-btn:hover:not(:disabled) {
  ...
  color: var(--brand-navy);
  transform: translateY(-2px);
  box-shadow: 0 4px 12px rgba(26, 26, 64, 0.15);
}
...
.pagination-btn.active {
  ...
  border-color: var(--brand-navy);
  color: white;
  box-shadow: 0 4px 12px rgba(26, 26, 64, 0.35);
}
