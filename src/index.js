...
/* ============================================
   FLOW SIMULATOR - Interactive Chat Experience
   ============================================ */
.flow-simulator {
  display: grid;
...
.sim-nav-badge.success { background: #dcfce7; color: #166534; }
.sim-nav-badge.refund { background: #fef3c7; color: #92400e; }
.sim-nav-badge.decision { background: #e8d5e8; color: #6b21a8; }
...
/* Chat Messages in Simulator */
.sim-msg {
  display: flex;
  gap: 10px;
  max-width: 85%;
  animation: simMsgIn 0.3s ease;
}
...
.sim-msg-sender.sarah { color: #d97706; }
...
/* Editable messages in docs panel */
.sim-docs-message {
  background: var(--gray-50);
  border-radius: var(--radius-md);
  padding: 14px;
