  ...
  <style>
    ...
    * {
    ...
    .stat-card.highlight {
      ...
      color: white;
      border: none;
      box-shadow: 0 12px 40px rgba(26, 54, 93, 0.3), 0 4px 12px rgba(26, 54, 93, 0.2);
    }
...
:root {
  ...
  --sakura-soft: rgba(255, 183, 197, 0.15);
  --sora: #A8D8EA;         /* Sky blue */
  --sora-soft: rgba(168, 216, 234, 0.15);
  --momo: #FFDAB9;         /* Peach */
...
.case-detail-header::after {
  ...
  width: 120px;
  height: 3px;
  background: linear-gradient(90deg, var(--brand-navy) 0%, var(--sora) 100%);
  border-radius: 2px;
}
...
/* Subtle colored accent based on section type */
.case-detail-section-header::before {
  content: '';
  position: absolute;
  left: 0;
  top: 0;
  bottom: 0;
  width: 4px;
  background: linear-gradient(180deg, var(--brand-navy) 0%, var(--sora) 100%);
...
.quick-action-btn.sop-link {
  ...
  color: #1e6091;
  border: none;
  box-shadow: 0 4px 14px rgba(168, 216, 234, 0.4);
}

.quick-action-btn.sop-link:hover {
  background: linear-gradient(135deg, #8bc4d6 0%, #7ab8cc 100%);
  transform: translateX(4px);
...
.quick-action-btn.email-btn {
  ...
  color: #2d6a4f;
  border: none;
  box-shadow: 0 4px 14px rgba(200, 230, 201, 0.4);
}

.quick-action-btn.email-btn:hover {
  background: linear-gradient(135deg, #9fd4a0 0%, #8ec990 100%);
  transform: translateX(4px);
  box-shadow: 0 6px 20px rgba(200, 230, 201, 0.5);
}
